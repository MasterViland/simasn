...
return new class extends Migration 
{
    ...
    {
        Schema::create('anak_tampungan', function (Blueprint $table) {
            ...
            $table->foreign('pasangan_id')->references('id')->on('pasangan')->nullOnDelete();
            ...
            $table->string('file_path_akte_lahir', 255)->nullable();
    ...
    {
        Schema::dropIfExists('anak_tampungan');
    }
};